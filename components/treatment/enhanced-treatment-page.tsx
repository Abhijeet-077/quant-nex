      ...
      <div className="min-h-screen bg-black p-6">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 flex justify-between items-center">
            <h1 className="text-3xl font-bold text-white glow-text">Advanced Treatment Planning</h1>
          ...
          <div className="col-span-12 lg:col-span-8 space-y-6">
            ...
            <Card className="card-glow border-blue-500/30">
              <CardHeader>
                <CardTitle className="text-xl text-white flex items-center glow-text">
                  <Activity className="h-5 w-5 mr-2 text-green-400 neon-glow" />
                  <span>Treatment Efficacy Analysis</span>
                </CardTitle>
              </CardHeader>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-6">
            ...
            <Card className="card-glow border-blue-500/30">
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className="text-xl text-white glow-text">Quantum Optimization</CardTitle>
                  <Button
                    variant="outline"
                    size="sm"
            ...
            <Card className="card-glow border-blue-500/30">
              <CardHeader>
                <CardTitle className="text-xl text-white glow-text">Treatment Protocol</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
            ...
            <Card className="card-glow border-blue-500/30">
              <CardHeader>
                <CardTitle className="text-xl text-white flex items-center glow-text">
                  <AlertTriangle className="h-5 w-5 mr-2 text-yellow-400 neon-glow" />
